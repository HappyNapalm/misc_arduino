...
void loop() {
//Poll the input pins
  bool red_button = digitalRead(start_button);
  bool upper_left = digitalRead(limit_upper_left);
  bool upper_right = digitalRead(limit_upper_right);
  bool lower_left = digitalRead(limit_lower_left);
  bool lower_right = digitalRead(limit_lower_right);
  bool still_here = digitalRead(motion_pin);
